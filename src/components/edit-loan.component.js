...
export default class EditLoans extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        axios.get('http://localhost:5000/loans/'+this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/loans/update/'+this.props.match.params.id, loan) //send data to mongodb
            .then((res) => {
